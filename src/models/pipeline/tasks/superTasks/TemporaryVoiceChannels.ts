...
import Discord, {CategoryChannel, GuildVoiceChannelResolvable, PermissionsBitField, VoiceState} from "discord.js";
...
export class TemporaryVoiceChannels extends SuperTask {
    ...
    private async deleteChannelOnUserLeave() {
    ...
    private async createChannelAndMoveUser() {
        ...
        let fCategory = await guild.channels.fetch(categoryId) as CategoryChannel
        ...
        await fetchedUser.voice.setChannel(channel as GuildVoiceChannelResolvable, "Move")
        return true
    }

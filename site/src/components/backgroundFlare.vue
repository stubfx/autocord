...
<!--    <bg_wave class="absolute w-full h-auto bottom-0 fill-secondary mt-20"></bg_wave>-->
...
import Bg_wave from "../assets/bg_wave.vue";

export default {
  name: "backgroundFlare",
  components: {Bg_wave},
  mounted() {
    // const staggerVisualizerEl = this.$refs.bg.$el;
    //

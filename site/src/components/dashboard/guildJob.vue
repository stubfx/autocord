<template>
  ...
  <div class="flex flex-col flex-wrap bg-discord-5 p-6 w-[400px] rounded m-5 items-center shadow-2xl gap-5">
    <div class="flex flex-row w-full items-center">
      ...
      <save_rounded class="fill-discord-success rounded-full rounded w-7 h-7 cursor-pointer" @click="onSaveJob"
